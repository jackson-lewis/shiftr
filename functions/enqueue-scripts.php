...
function shiftr_scripts() {
    ...
    wp_register_script( 'shiftr-glide', get_template_directory_uri() . '/assets/scripts/glide.js', [], $shiftr->get( 'version' ), true );
    
    if ( shiftr_page_uses_glidejs() ) {
        wp_enqueue_script( 'shiftr-glide' );
    }
