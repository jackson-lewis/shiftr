...
new Flexi_Block(
    ...
    'Gallery',
    array(
        Field_Types\gallery_field( 'Images', array( 'return_format' => 'id' ) ),
        Field_Types\group_field( 'CTA Banner', array(
            'sub_fields' => array(
                Field_Types\text_field( 'Label', array(
                    'key' => 'field_gallery-cta_label',
                    'wrapper' => array(
                        'width' => '40'
                    )
                )),
                Field_Types\text_field( 'Link', array(
                    'key' => 'field_gallery-cta_link',
                    'wrapper' => array(
                        'width' => '30'
                    )
                )),
                Field_Types\text_field( 'Link label', array(
                    'key' => 'field_gallery-cta_link-label',
                    'wrapper' => array(
                        'width' => '30'
                    )
                ))
